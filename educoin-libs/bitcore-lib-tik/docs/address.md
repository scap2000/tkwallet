...
The errors are listed in the generated file in the [errors folder](https://github.com/tkcoin/bitcore/tree/master/packages/bitcore-lib/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/tkcoin/bitcore/tree/master/packages/bitcore-lib/lib/errors/spec.js).
