...
- [Support Forum](https://labs.tkcoin.org/c/bitcore)
- [Development Chat](https://gitter.im/tkcoin/bitcore)
...
```sh
git remote add tkcoin git@github.com:tkcoin/bitcore.git
git pull --rebase tkcoin master
```
...
Finally go to [github.com/tkcoin/bitcore](https://github.com/tkcoin/bitcore) in your web browser and issue a new pull request.
...
[github.com/tkcoin/bitcore/issues](https://github.com/tkcoin/bitcore/issues).
