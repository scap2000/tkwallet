...
export class API extends EventEmitter {
  ...
  static BitcoreEdu = CWC.BitcoreLibEdu;
  static BitcoreTik = CWC.BitcoreLibTik;
  ...
  /**
   * Create advertisement for tkcoin app - (limited to marketing staff)
   * @param opts - options
   */
  ...
  /**
   * Get advertisements for tkcoin app - (limited to marketing staff)
   * @param opts - options
  ...
  /**
   * Get advertisements for tkcoin app, for specified country - (limited to marketing staff)
   * @param opts - options
