...
describe('PayProProvider', () => {
  ...
  const defaultPayPro = {
    verified: true,
    network: 'livenet',
    payProUrl: 'https://tkcoin.org/i/5GREtmntcTvB9aejVDhVdm',
    coin: 'btc',
    requiredFeeRate: 134.972,
    amount: 278800,
    toAddress: '1Jzx8hv7Mz8DZH2QoLiWyFBCsCqK1yjwwz',
    memo:
      'Payment request for TKCoin invoice DEkTtRXp6ni7n7WwUan4y for merchant Electronic Frontier Foundation',
  ...
  describe('getPayProDetails', () => {
    it('should return paypro details', () => {
      ...
      payproProvider
        .getPayProDetails({
          paymentUrl: 'https://tkcoin.org/i/5GREtmntcTvB9aejVDhVdm',
          coin: 'btc'
        })
        .then(paypro => {
