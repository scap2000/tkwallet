...
describe('RateProvider', () => {
  ...
  const btcResponse = [
    ...
    { code: 'EDU', name: 'Educoin', rate: 1 },
    { code: 'TIK', name: 'TKCoin', rate: 1 },
  ...
  let btcUrl: string = 'http://172.20.30.162:3232/bws/api/v3/fiatrates/btc';
  let eduUrl: string = 'http://172.20.30.162:3232/bws/api/v3/fiatrates/edu';
  let tikUrl: string = 'http://172.20.30.162:3232/bws/api/v3/fiatrates/tik';
  let bchUrl: string = 'http://172.20.30.162:3232/bws/api/v3/fiatrates/bch';
  let ethUrl: string = 'http://172.20.30.162:3232/bws/api/v3/fiatrates/eth';
  let xrpUrl: string = 'http://172.20.30.162:3232/bws/api/v3/fiatrates/xrp';
  let paxUrl: string = 'http://172.20.30.162:3232/bws/api/v3/fiatrates/pax';
  let usdcUrl: string = 'http://172.20.30.162:3232/bws/api/v3/fiatrates/usdc';
  let gusdUrl: string = 'http://172.20.30.162:3232/bws/api/v3/fiatrates/gusd';
  let busdUrl: string = 'http://172.20.30.162:3232/bws/api/v3/fiatrates/busd';
  let dogeUrl: string = 'http://172.20.30.162:3232/bws/api/v3/fiatrates/doge';
  // let daiUrl: string = 'http://172.20.30.162:3232/bws/api/v3/fiatrates/dai';
  // let wbtcUrl: string = 'http://172.20.30.162:3232/bws/api/v3/fiatrates/wbtc';

  let fiatRateUrl: string =
    'http://172.20.30.162:3232/bws/api/v1/fiatrates/USD?coin=btc&ts=1559315523000';
  ...
  it('should see if rates are available', () => {
    service.updateRates().then(() => {
      ...
      httpMock.match(eduUrl)[1].flush(eduResponse);
      httpMock.match(tikUrl)[0].flush(tikResponse);
  ...
  it('should get BTC rates', () => {
    service.updateRates().then(() => {
      ...
      httpMock.match(ethUrl)[0].flush(ethResponse);
      httpMock.match(btcUrl)[1].flush(btcResponse);
      httpMock.match(eduUrl)[0].flush(eduResponse);
      httpMock.match(tikUrl)[0].flush(tikResponse);
      httpMock.match(bchUrl)[0].flush(bchResponse);
      httpMock.match(xrpUrl)[0].flush(xrpResponse);
      httpMock.match(paxUrl)[0].flush(paxResponse);
  ...
  it('should get EDU rates', () => {
    service.updateRates().then(() => {
      service.updateRates('edu').then(() => {
        expect(service.isCoinAvailable('edu')).toBe(true);
        expect(service.getRate('BTC', 'edu')).toEqual(0.130377);
        expect(service.getRate('EDU', 'edu')).toEqual(1);
        expect(service.getRate('USD', 'edu')).toEqual(11535.74);
        expect(service.getRate('BCH', 'edu')).toEqual(7.65734);
        expect(service.getRate('ETH', 'edu')).toEqual(5.65734);
        expect(service.getRate('XRP', 'edu')).toEqual(32482.54);
        expect(service.getRate('DOGE', 'edu')).toEqual(200000);
      });
  ...
  it('should get TIK rates', () => {
    service.updateRates().then(() => {
      service.updateRates('tik').then(() => {
        expect(service.isCoinAvailable('tik')).toBe(true);
        expect(service.getRate('BTC', 'tik')).toEqual(0.130377);
        expect(service.getRate('EDU', 'tik')).toEqual(1);
        expect(service.getRate('TIK', 'tik')).toEqual(1);
        expect(service.getRate('USD', 'tik')).toEqual(11535.74);
        expect(service.getRate('BCH', 'tik')).toEqual(7.65734);
        expect(service.getRate('ETH', 'tik')).toEqual(5.65734);
        expect(service.getRate('XRP', 'tik')).toEqual(32482.54);
        expect(service.getRate('DOGE', 'tik')).toEqual(200000);
      });

      httpMock.match(ethUrl)[0].flush(ethResponse);
      httpMock.match(btcUrl)[0].flush(btcResponse);
      httpMock.match(eduUrl)[0].flush(eduResponse);
      httpMock.match(tikUrl)[1].flush(tikResponse);
      httpMock.match(bchUrl)[0].flush(bchResponse);
      httpMock.match(xrpUrl)[0].flush(xrpResponse);
      httpMock.match(paxUrl)[0].flush(paxResponse);
      httpMock.match(usdcUrl)[0].flush(usdcResponse);
