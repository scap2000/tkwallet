...
export class BwcProvider {
  ...
  public getBitcoreEdu() {
    return BWC.BitcoreEdu;
  }

  public getBitcoreTik() {
    return BWC.BitcoreTik;
  }
  ...
  public getClient(walletData?, opts?) {
    ...
    let bwc = new BWC({
      baseUrl: opts.bwsurl || 'https://bws.tkcoin.org/bws/api', // 'http://localhost:3232/bws/api', uncmment for local testing
