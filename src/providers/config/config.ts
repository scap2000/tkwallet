...
export class ConfigProvider {
  ...
  constructor(
    ...
    this.configDefault = {
      ...
      download: {
        tkcoin: {
          url: '',// TODO FIX 'https://tkcoin.org/wallet'
        },
        copay: {
          url: '',// TODO FIX 'https://copay.io/#download'
        }
      },
      ...
      rateApp: {
        tkcoin: {
          ios:
            '',// TODO FIX 'https://itunes.apple.com/app/tkcoin-secure-bitcoin-wallet/id1149581638',
          android:
            '',// TODO FIX 'https://play.google.com/store/apps/details?id=com.tkcoin.wallet',
          wp: ''
        },
        copay: {
          ios: '',// TODO FIX 'https://itunes.apple.com/app/copay-bitcoin-wallet/id951330296',
          android:
              '',// TODO FIX 'https://play.google.com/store/apps/details?id=com.tkcoin.copay',
          wp: ''
        }
      },
