...
export class CopayApp {
  ...
  constructor(
    ...
    private tkcoinProvider: TKCoinProvider,
  ...
  private async onAppLoad(readySource) {
    ...
    let [token, cards]: any = await Promise.all([
      this.persistenceProvider.getTKCoinIdPairingToken(Network[this.NETWORK]),
    ...
    if (
      ...
      const host =
        this.NETWORK === 'testnet' ? 'test.tkcoin.org' : 'tkcoin.org';
