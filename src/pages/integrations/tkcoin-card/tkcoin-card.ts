...
import { TKCoinProvider } from '../../../providers/tkcoin/tkcoin';
...
@Component({
  selector: 'page-tkcoin-card',
  templateUrl: 'tkcoin-card.html'
})
export class TKCoinCardPage {
  public network: string;
  public dateRange;
  public cardId: string;
  public getStarted: boolean;
  public loadingHistory: boolean;
  public tkcoinCardTransactionHistoryCompleted;
  public tkcoinCardTransactionHistoryConfirming;
  public tkcoinCardTransactionHistoryPreAuth;
  ...
  constructor(
    ...
    private bitPayProvider: TKCoinProvider,
  ...
  private setHistory(txs) {
    if (!txs) return;
    this.tkcoinCardTransactionHistoryConfirming = this.bitPayCardProvider.filterTransactions(
      'confirming',
      txs
    );
    this.tkcoinCardTransactionHistoryCompleted = this.bitPayCardProvider.filterTransactions(
      'completed',
      txs
    );
    this.tkcoinCardTransactionHistoryPreAuth = this.bitPayCardProvider.filterTransactions(
      'preAuth',
      txs
    );
  }
