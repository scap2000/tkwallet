...
export class AboutPage {
  ...
  public async wipeTKCoinAccounts() {
    this.tapped++;
    if (this.tapped >= 10) {
      await this.persistenceProvider.removeAllTKCoinAccounts(
        this.tkcoinProvider.getEnvironment().network
      );
