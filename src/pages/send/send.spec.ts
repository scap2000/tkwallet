  ...
  describe('processInput', () => {
    describe('for wallets btc livenet', () => {
      ...
      it('should handle btc livenet paypro and call to redir function', fakeAsync(() => {
        ...
        const mockPayPro = Promise.resolve({
          ...
          memo:
            'Payment request for TKCoin invoice MB6kXuVY9frBW1DyoZkE5e for merchant Johnco',
          payProUrl: 'https://tkcoin.org/i/MB6kXuVY9frBW1DyoZkE5e',
          paymentOptions: [
            {
              chain: 'BTC',
              currency: 'BTC',
        ...
        instance.search =
          'bitcoin:?r=https://tkcoin.org/i/MB6kXuVY9frBW1DyoZkE5e';
        instance.processInput();
        tick();
        expect(instance.invalidAddress).toBeFalsy();
        expect(redirSpy).toHaveBeenCalledWith(
          'https://tkcoin.org/i/MB6kXuVY9frBW1DyoZkE5e',
          'btc',
          undefined,
          true,
          'SendPage'
      ...
      it('should handle paypro bch livenet and call error modal', fakeAsync(() => {
        ...
        const mockPayPro = Promise.resolve({
          expires: '2019-11-05T16:29:31.754Z',
          memo:
            'Payment request for TKCoin invoice 3dZDvRXdxpkL4FoWtkB6ZZ for merchant Johnco',
          payProUrl: 'https://tkcoin.org/i/3dZDvRXdxpkL4FoWtkB6ZZ',
          paymentOptions: [
            {
              chain: 'BCH',
              currency: 'BCH',
        ...
        instance.search =
          'bitcoincash:?r=https://tkcoin.org/i/3dZDvRXdxpkL4FoWtkB6ZZ';
        instance.processInput();
        tick();
        expect(instance.invalidAddress).toBeTruthy();
        expect(errorModalSpy).toHaveBeenCalled();
      ...
      it('should handle paypro bch testnet and call error modal', fakeAsync(() => {
        ...
        const mockPayPro = Promise.resolve({
          expires: '2019-11-05T16:29:31.754Z',
          memo:
            'Payment request for TKCoin invoice JTfRobeRFmiCjBivDnzV1Q for merchant Johnco',
          payProUrl: 'https://test.tkcoin.org/i/JTfRobeRFmiCjBivDnzV1Q',
          paymentOptions: [
            {
              chain: 'BCH',
              currency: 'BCH',
        ...
        instance.search =
          'bitcoincash:?r=https://test.tkcoin.org/i/JTfRobeRFmiCjBivDnzV1Q';
        instance.processInput();
        tick();
        expect(instance.invalidAddress).toBeTruthy();
        expect(errorModalSpy).toHaveBeenCalled();
      ...
      it('should handle paypro btc testnet and call error modal', fakeAsync(() => {
        ...
        const mockPayPro = Promise.resolve({
          expires: '2019-11-05T16:29:31.754Z',
          memo:
            'Payment request for TKCoin invoice S5jbsUtrHVuvYQN6XHPuvJ for merchant Johnco',
          payProUrl: 'https://test.tkcoin.org/i/S5jbsUtrHVuvYQN6XHPuvJ',
          paymentOptions: [
            {
              chain: 'BTC',
              currency: 'BTC',
        ...
        instance.search =
          'bitcoin:?r=https://test.tkcoin.org/i/S5jbsUtrHVuvYQN6XHPuvJ';
        instance.processInput();
        tick();
        expect(instance.invalidAddress).toBeTruthy();
        expect(errorModalSpy).toHaveBeenCalled();
    ...
    describe('for wallets btc testnet', () => {
      ...
      it('should handle btc testnet paypro and call to redir function', fakeAsync(() => {
        ...
        expect(instance.invalidAddress).toBeFalsy();
        expect(redirSpy).toHaveBeenCalledWith(
          'https://test.tkcoin.org/i/S5jbsUtrHVuvYQN6XHPuvJ',
          'btc',
          undefined,
          true,
          'SendPage'
    ...
    describe('for wallets bch livenet', () => {
      ...
      it('should handle bch livenet paypro and call to redir function', fakeAsync(() => {
        ...
        expect(instance.invalidAddress).toBeFalsy();
        expect(redirSpy).toHaveBeenCalledWith(
          'https://tkcoin.org/i/3dZDvRXdxpkL4FoWtkB6ZZ',
          'bch',
          undefined,
          true,
          'SendPage'
