...
import { TKCoinCardPage } from '../pages/integrations/tkcoin-card/tkcoin-card';
import { TKCoinCardHome } from '../pages/integrations/tkcoin-card/tkcoin-card-home/tkcoin-card-home';
import { TKCoinCardIntroPage } from '../pages/integrations/tkcoin-card/tkcoin-card-intro/tkcoin-card-intro';
import { TKCoinCardTopUpPage } from '../pages/integrations/tkcoin-card/tkcoin-card-topup/tkcoin-card-topup';
import { TKCoinSettingsPage } from '../pages/integrations/tkcoin-card/tkcoin-settings/tkcoin-settings';

// Integrations: TKCoinCard - Phases

// Phase 1
import { PhaseOneCardIntro } from '../pages/integrations/tkcoin-card/tkcoin-card-phases/phase-one/phase-one-intro-page/phase-one-intro-page';
...
import { TKCoinIdPage } from '../pages/settings/tkcoin-id/tkcoin-id';
